...
export default function Header() {
  return (
    <div className="text-center flex flex-col items-center mt-6 px-4">
      <h1 className='mb-6 text-2xl font-bold'>Fullstack developer 👋 </h1>
      <p className='mb-6 text-base font-normal max-w-96 sm:max-w-none'>Hey, it's Ehab! I'm a versatile Fullstack Developer, Based in Egypt. 🎈</p>
